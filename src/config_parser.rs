...
const DEFAULT_CONFIG: &'static str = "# The token of the bot: https://discordpy.readthedocs.io/en/latest/discord.html
token = \"TOKEN HERE\"
...
impl Config {
    ...
    pub fn set(config_path: &str) {
        let config: Config = toml::from_str(&fs::read_to_string(config_path).unwrap_or_else(|err| {
